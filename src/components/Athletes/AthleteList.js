  ...
  if (error) {
    return (
      <div className="athlete-list">
        ...
        <button onClick={fetchAthletes} className="btn btn-primary">Retry</button>
      </div>
    );
  }
            ...
            <div key={athlete.id} className="athlete-card">
              ...
              <div className="athlete-info">
                ...
                <div className="info-row">
                  ...
                  <span className="value">{getBeltLabel(athlete.beltRank)}</span>
                </div>
                <div className="info-row">
                  <span className="label">Age:</span>
                  <span className="value">{calculateAge(athlete.dateOfBirth)} years</span>
                </div>
                <div className="info-row">
